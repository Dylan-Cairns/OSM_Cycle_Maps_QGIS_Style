...
<qgis maxScale="0" version="3.18.2-Zürich" labelsEnabled="1" simplifyMaxScale="1" simplifyLocal="1" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1">
  <flags>
  ...
  <temporal fixedDuration="0" mode="0" accumulate="0" startField="" durationUnit="min" endField="" startExpression="" durationField="" endExpression="" enabled="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{da13a45e-329f-4824-b96e-f14d12cc6cec}">
      <rule key="{c0545fa7-1679-49da-bd06-491c80b53607}" symbol="0" filter="&quot;fclass&quot; = 'peak'"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{10bacde4-ebdf-4b99-8fd3-3a74b5e4a51f}">
      <rule key="{019936fa-687d-483c-b674-69228d5b449e}" filter="&quot;fclass&quot; = 'peak'">
        <settings calloutType="simple">
          <text-style fontItalic="0" previewBkgrdColor="255,255,255,255" isExpression="0" fontFamily="Noto Sans" capitalization="0" fontSizeUnit="Point" multilineHeight="1" fontWordSpacing="0" allowHtml="0" fontStrikeout="0" fieldName="name" fontLetterSpacing="0" fontWeight="50" fontKerning="1" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" textOpacity="1" textOrientation="horizontal" fontSize="15" blendMode="0" textColor="0,0,0,255" namedStyle="Regular">
            <text-buffer bufferNoFill="1" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferSize="1" bufferOpacity="1"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory spacing="5" height="15" lineSizeType="MM" penWidth="0" barWidth="5" minimumSize="0" maxScaleDenominator="1e+08" enabled="0" scaleDependency="Area" lineSizeScale="3x:0,0,0,0,0,0" rotationOffset="270" minScaleDenominator="0" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" showAxis="1" width="15" labelPlacementMethod="XHeight" penAlpha="255" opacity="1" backgroundColor="#ffffff" sizeType="MM" diagramOrientation="Up" spacingUnit="MM" scaleBasedVisibility="0" backgroundAlpha="255">
  ...
  <constraints>
    <constraint field="osm_id" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="code" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint field="fclass" unique_strength="0" exp_strength="0" constraints="0" notnull_strength="0"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="686" type="field" name="name"/>
